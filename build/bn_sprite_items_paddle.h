...
#define paddle_bn_gfxTilesLen 64
extern const bn::tile paddle_bn_gfxTiles[2];
...
{
    constexpr inline sprite_item paddle(sprite_shape_size(sprite_shape::WIDE, sprite_size::SMALL), 
            sprite_tiles_item(span<const tile>(paddle_bn_gfxTiles, 2), bpp_mode::BPP_4, compression_type::NONE, 1), 
