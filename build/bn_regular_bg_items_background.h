...
#define background_bn_gfxTilesLen 64
extern const bn::tile background_bn_gfxTiles[2];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item background(
            regular_bg_tiles_item(span<const tile>(background_bn_gfxTiles, 2), bpp_mode::BPP_4, compression_type::NONE), 
